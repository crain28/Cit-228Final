...
//gather the topics
$get_topics_sql = "SELECT topic_id, topic_title, DATE_FORMAT(topic_create_time,  '%b %e %Y at %r') as fmt_topic_create_time, topic_owner FROM FunGroup_topics ORDER BY topic_create_time DESC";
...
END_OF_TEXT;
	...
	while ($topic_info = mysqli_fetch_array($get_topics_res)) {
		...
		//get number of posts
		$get_num_posts_sql = "SELECT COUNT(post_id) AS post_count FROM FunGroup_posts WHERE topic_id = '".$topic_id."'";
...
<html>
<head>
<title>Topics in My FunGroup</title>
