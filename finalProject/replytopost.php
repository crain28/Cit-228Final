...
if (!$_POST) {
   ...
   $verify_sql = "SELECT ft.topic_id, ft.topic_title FROM FunGroup_posts
                  AS fp LEFT JOIN FunGroup_topics AS ft ON fp.topic_id =
...
<?php
      ...
      //add the post
      $add_post_sql = "INSERT INTO FunGroup_posts (topic_id,post_text,
